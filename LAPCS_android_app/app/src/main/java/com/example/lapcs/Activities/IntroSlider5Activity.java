...
public class IntroSlider5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intro_slider5);
        ...
        m_BtnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent mainIntent = new Intent(IntroSlider5Activity.this,
                        MainActivity.class);
                startActivity(mainIntent);
                IntroSlider5Activity.this.finish();
            }
        });
