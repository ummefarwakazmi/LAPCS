...
public class IntroSlider4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_BtnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent mainIntent = new Intent(IntroSlider4Activity.this,
                        IntroSlider5Activity.class);
                startActivity(mainIntent);
                IntroSlider4Activity.this.finish();
            }
        });
