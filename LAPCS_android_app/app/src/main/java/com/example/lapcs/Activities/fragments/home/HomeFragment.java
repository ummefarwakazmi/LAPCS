                    ...
                    public void onComplete(@NonNull Task<InstanceIdResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            try {
                                ...
                                e.printStackTrace();
                                Toast.makeText(getContext(),"Token generation Exception",Toast.LENGTH_LONG).show();
                                Log.d(TAG,this.getClass().getName()+": "+"Token generation Exception");
                            }
                        } else {
                            Toast.makeText(getContext(),"Token generation failed",Toast.LENGTH_LONG).show();
    ...
    public  void SaveDeviceToken(String NewDeviceToken)
    {
        try
        {
            ...
            if (ActivityCompat.checkSelfPermission(getContext(), android.Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(getActivity(), "Device Linking Error!! IMEI Reading Permission not Assigned", Toast.LENGTH_LONG).show();
            ...
            mDatabase.child(AppConsts.Parent_Meta_Data_Node_Ref).child(parentID).child("tokenId").addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    {
                        Toast.makeText(getContext(), "Token Already Saved", Toast.LENGTH_LONG).show();
                    ...
                    else
                    {
                        ...
                        Toast.makeText(getContext(),"Parent Token Generated: " + App.DeviceToken,Toast.LENGTH_LONG).show();
                        mFirebaseDatabaseParentMetaData.child(parentID).setValue(parentMetaData);
                        //displaying a success toast
                        Toast.makeText(getContext(), "Token Saved Successfully. This is Test Notification!", Toast.LENGTH_LONG).show();
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    ...
                    Toast.makeText(getContext(), "The read failed: " + databaseError.getMessage(), Toast.LENGTH_LONG).show();
            ...
            e.printStackTrace();
            Toast.makeText(getContext(),"Parent Metadata Exception: "+e.getMessage(),Toast.LENGTH_LONG).show();
