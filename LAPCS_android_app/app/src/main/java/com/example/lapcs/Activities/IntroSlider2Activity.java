...
public class IntroSlider2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intro_slider2);

        m_BtnNext = (Button) findViewById(R.id.BtnNext);
        m_BtnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent mainIntent = new Intent(IntroSlider2Activity.this,
                        IntroSlider4Activity.class);
                startActivity(mainIntent);
                IntroSlider2Activity.this.finish();
            }
        });
